            ...
            <div className="container mx-auto px-4 sm:px-8 lg:px-16 text-center">
                ...
                <div className="max-w-3xl mx-auto">
                    <p className="text-sm sm:text-base lg:text-lg leading-relaxed mb-10">
                        Hello! I&#39;m Samuli, an ultra-runner, junior  programmer, and aspiring cybersecurity specialist from Finland.
                    </p>
                    <p className="text-sm sm:text-base lg:text-lg leading-relaxed mb-10">
                    ...
                    <p className="text-sm sm:text-base lg:text-lg leading-relaxed">
                        What drives me even further is my passion for Cybersecurity. I&#39;m currently immersing myself in this dynamic field, eager to master
